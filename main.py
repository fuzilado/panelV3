...
def menu():
    ...
    os.system("clear")
    print("Coded By: \033[1;36m HUGO \033[m and \033[1;36m NINGUEM \033[m in 07/02/2021")
    print()
    os.system("figlet HUGO")
